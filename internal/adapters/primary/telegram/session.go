...
const (
	...
	StateAwaitingAmount        SearchState = "awaiting_amount"   // StateAwaitingAmount indicates the bot is waiting for a transaction amount.
	StateAwaitingDescription   SearchState = "awaiting_desc"     // StateAwaitingDescription indicates the bot is waiting for a transaction description.
...
type UserSession struct {
	...
	TemporaryAmount       string // Stores the amount entered in the wizard before parsing
